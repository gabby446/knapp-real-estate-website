...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert('There was an error sending your message. Please try calling us directly at (512) 924-5095.')
    }
  }
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="tel:512-924-5095" className="text-royal-blue font-medium hover:underline">
                      (512) 924-5095
                    </a>
                  </div>
                </div>
