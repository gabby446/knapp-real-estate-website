...
export default function FAQPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Payment terms typically range from 5-10 years, depending on develo but we're flexible and can work with you to find terms that fit your financial situation. You can also pay off your lot early without penalty."
    },
    {
